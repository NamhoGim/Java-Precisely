...
class Nfa {
    ...
    private final Integer exitState;    // This is the unique accept state
    private final Map<Integer, List<Transition>> trans;
...
class Dfa {
    ...
    private final Map<Integer, Map<String, Integer>> trans;
